        ...
        <>   
            <div className="fashion-carouselImg-con">
                 {photos!==""&& photos.map(each=>(
                        <div className="fashion-carousel-content" style={{transform:`translate(-${activeIndex * 100}%)`, backgroundImage: `url(${each})`}}>
                            <button className="star-btn" type="button">{rating}<img className='rating-star2' src="/ratingstar.png" alt="rating"/></button>
